...
/**
 * The activity for showing full size selfie
 * @author WilliamWei
 *
 */
public class FullScreenSelfieActivity extends Activity {
	
	private static final String TAG = "FullScreenSelfieActivity";
